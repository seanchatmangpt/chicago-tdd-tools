...
mod tests {
    ...
    fn test_mutation_tester_apply_add_key() {
        ...
        let mut tester = MutationTester::new(data);
        let mutated = tester.apply_mutation(MutationOperator::AddKey("key2".to_string(), "value2".to_string()));
    ...
    fn test_mutation_tester_apply_change_value() {
        ...
        let mut tester = MutationTester::new(data);
        let mutated = tester.apply_mutation(MutationOperator::ChangeValue("key1".to_string(), "new_value".to_string()));
    ...
    fn test_mutation_tester_apply_change_value_nonexistent() {
        ...
        let mut tester = MutationTester::new(data);
        let mutated = tester.apply_mutation(MutationOperator::ChangeValue("nonexistent".to_string(), "value".to_string()));
        
        assert_eq!(mutated.len(), 1, "Data should remain unchanged");
        assert_eq!(mutated.get("key1"), Some(&"value1".to_string()), "Original value should remain");
    }
